...
class PdoGsb{   		
      	private static $serveur='mysql:host=172.23.221.28:3308';
      	private static $bdd='dbname=gsbfrais';   		
      	private static $user='GsbFraisUser' ;    		
      	private static $mdp='GsbFraisUser' ;	
 ...
 */
    ...
    public function getAllVisitors()
    {
        ...
        $res = PdoGsb::$monPdo->query($req);
        $visiteurs = $res->fetchAll(PDO::FETCH_ASSOC);
